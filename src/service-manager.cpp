...
vector<string> service_description = {"No services used","Gym","Birthday party","Car rental","Pet spa","Food delivery","Spa and massage"};
...
bool ServiceManager::ShowListService(){
    ...
    cout << left << setw(20) << "Name" << setw(20) << "Fee" << endl;
    // Dòng kẻ ngang
